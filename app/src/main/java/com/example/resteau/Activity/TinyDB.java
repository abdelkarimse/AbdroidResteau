...
public class TinyDB {
    ...
    public ArrayList<FoodDomainse> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FoodDomainse> playerList =  new ArrayList<FoodDomainse>();

        for(String jObjString : objStrings){
            FoodDomainse player  = gson.fromJson(jObjString,  FoodDomainse.class);
    ...
    public void putListObject(String key, ArrayList<FoodDomainse> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FoodDomainse player: playerList){
